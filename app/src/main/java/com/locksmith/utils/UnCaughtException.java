...
import com.locksmith.PrepCards.R;
...
public class UnCaughtException implements UncaughtExceptionHandler {
	...
	private void addInformation(StringBuilder message) {
		...
		try {
			...
			message.append("ClassName: ").append(context1.getClass()).append('\n');
		} catch (Exception e) {
	...
	public void uncaughtException(Thread t, Throwable e) {
		try {
			...
			printWriter.close();
			report.append('\n');
			report.append("********** End of Error Log **********");
	...
	public void sendErrorMail(final StringBuilder errorContent) {
		final AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(context, R.style.AppBaseTheme));
		...
		new Thread() {
			...
			public void run() {
				Looper.prepare();
				builder.setTitle("Oops, We are very Sorry...");
				builder.create();
				...
				builder.setPositiveButton("Report Now",
						new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog,int which) 
					{
						...
						sendIntent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[] { "error@locksmith.sr" });
				...
				builder.setMessage("Due to some unfortunate reasons Your application has crashed.");
				builder.show();
				Looper.loop();
			}
		}.start();
